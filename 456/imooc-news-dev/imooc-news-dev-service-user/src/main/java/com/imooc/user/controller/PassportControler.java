 ...
 * @Author:刘震
 * @Description:
 * @Date: Created in11:45 2021/3/5.
 * @Modified By:
 */
@RestController
@RequestMapping("passport")
public class PassportControler extends BaseController implements PassportControllerApi {
    final static Logger logger = LoggerFactory.getLogger(PassportControler.class);
    @Autowired
